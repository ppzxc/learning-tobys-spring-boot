...
public class ConditionalTest {
  ...
  void conditional2() {
    // true
    new ApplicationContextRunner().withUserConfiguration(Config3.class).run(context -> {
      assertThat(context).hasSingleBean(MyBean.class);
      assertThat(context).hasSingleBean(Config3.class);
    });

    // true
    new ApplicationContextRunner().withUserConfiguration(Config4.class).run(context -> {
      assertThat(context).doesNotHaveBean(MyBean.class);
